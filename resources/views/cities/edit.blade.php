                    ...
                    {!! Form::model($data, ['method' => 'PATCH','id'=>'form','enctype'=>'multipart/form-data']) !!}
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        {!! Html::decode(Form::label('province_id','Province<span class="text-danger">*</span>')) !!}
                                        {!! Form::select('province_id', $provinces,$data->province_id, array('class' => 'form-control','style'=>'font-size:11px')) !!}
                                        @if ($errors->has('province_id'))  
                                            {!! "<span class='span_danger'>". $errors->first('province_id')."</span>"!!} 
                                        @endif
                                    </div>
                                </div>
                                <div class="col-2">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        {!! Html::decode(Form::label('lat','City latitute <span class="text-danger">*</span>')) !!}
                                        {{ Form::text('lat', null, array('placeholder' => 'Enter city latitute','class' => 'form-control')) }}
                                        @if ($errors->has('lat'))  
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        {!! Html::decode(Form::label('lng','City longitute <span class="text-danger">*</span>')) !!}
                                        {{ Form::text('lng', null, array('placeholder' => 'Enter city longitude','class' => 'form-control')) }}
                                        @if ($errors->has('lng'))  
    ...
    <script>
        $(document).ready(function () {  
            ...
            $('#form').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('cities.update',$data->id) }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
