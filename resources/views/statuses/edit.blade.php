                            ...
                            <div class=" row">
                                <div class="col-10">
                                    <div class="form-group">
                                        {!! Html::decode(Form::label('name','Status<span class="text-danger">*</span>')) !!}
                                        {{ Form::text('name', null, array('placeholder' => 'Enter status','class' => 'form-control','autofocus' => ''  )) }}
                                        @if ($errors->has('name'))  
    ...
    <script>
        $(document).ready(function () {  
            ...
            $('#form').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('statuses.update',$data->id) }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
