                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a  href="{{ route('complaint_tags.index') }}" class="btn btn-primary btn-xs ml-auto">
                            ...
                            <div class=" row">
                                <div class="col-10">
                                    <div class="form-group">
                                        {!! Html::decode(Form::label('name','Complaint Tag <span class="text-danger">*</span>')) !!}
                                        {{ Form::text('name', null, array('placeholder' => 'Enter complaint tag','class' => 'form-control','autofocus' => ''  )) }}
                                        @if ($errors->has('name'))  
    ...
    <script>
        $(document).ready(function () {  
            ...
            $('#form').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('complaint_tags.update',$data->id) }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
