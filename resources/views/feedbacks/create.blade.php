                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a  href="{{ route('home') }}" class="btn btn-dark btn-xs ml-auto">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        {!! Html::decode(Form::label('feedback','Feedback <span class="text-danger">*</span>')) !!}
                                        {{ Form::textarea('feedback', null, array('placeholder' => 'Enter feedback','class' => 'form-control','autofocus' => ''  )) }}
                                        @if ($errors->has('feedback'))  
                                            {!! "<span class='span_danger'>". $errors->first('feedback')."</span>"!!} 
                                        @endif
                                    </div>
                                </div>
                            </div>
